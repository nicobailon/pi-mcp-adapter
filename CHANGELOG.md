...
### Added
- Stdio MCP servers can opt out of arbitrary adapter environment inheritance with `inheritEnv: false`; SDK platform defaults and explicit `env` overlays remain, and helper-process boundaries are documented. Thanks to [@zenolam](https://github.com/zenolam) for #509.
